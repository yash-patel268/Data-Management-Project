...
<body>
    <header>
        <nav>
            <ul class="navArea">
                <li><a href="../Patient Main Page Tables/doctorTable.php" class="nava">View Doctors</a></li>
            </ul>
        </nav>
    ...
    <div class="container">
        <div class="buttons">
            <a href="" class="btn btn-1">New Presciption</a>
            <a href="" class="btn btn-1">Current Presciptions</a>
            <a href="" class="btn btn-1">New Appointment</a>
